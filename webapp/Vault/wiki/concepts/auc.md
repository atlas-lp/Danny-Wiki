...
tags: [model-evaluation, metric]
sourced_from: Can An Ai Chatbot Pass A Data Science Interview Eika 9K23V4
---

# AUC (Area Under the Curve)

A performance metric derived from the ROC curve that the chatbot was asked to calculate for its logistic regression model.

## Relationships

- **is_derived_from**: [[roc-curve|Roc Curve]]
